      ...
      <div className="flex flex-col justify-between py-10 space-y-8 lg:flex-row lg:space-y-0">
        ...
        <div className="grid grid-cols-2 gap-x-5 mx-auto text-sm gap-y-5 lg:gap-y-8 lg:w-2/3 sm:grid-cols-4">
          <div className="space-y-3">
            <h3 className="tracking-wide uppercase text-[#ff26a2] font-medium">
              Product
            </h3>
          ...
          <div className="space-y-3">
            <h3 className="uppercase text-[#ff26a2] font-medium">Company</h3>
            <ul className="space-y-1">
              <li>
                <a
                  rel="noopener noreferrer"
          ...
          <div className="space-y-3">
            <div className="uppercase text-[#ff26a2] font-medium">
              Social media
            </div>
