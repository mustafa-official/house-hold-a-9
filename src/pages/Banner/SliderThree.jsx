  ...
  return (
    ...
    >
      ...
      <div className="max-w-xl">
          <h1 data-aos="fade-down" data-aos-duration="2000" className="mb-5 px-3 text-3xl md:text-5xl lg:text-6xl font-black">Discover Your Ideal <span className="animate-text bg-gradient-to-r from-blue-500 via-[#FE26A1] to-[#b4d343] bg-clip-text text-transparent">Residence</span></h1>
